...
public slots:
    ...
    void modifyParcelle(SqlCustomModel *model, int index, QString owner, QString parcelleFile, int speed, QStringList answers, QList<int> comboAnswers);
    void addParcelle(SqlCustomModel *model, QString ilotNumber, QString file, int speed, QStringList answers, QList<int> comboAnswers);
