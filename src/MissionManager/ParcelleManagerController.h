...
public slots:
    ...
    void modifyParcelle(SqlCustomModel *model, int index, QString owner, QString parcelleFile, QString type, int speed, QStringList answers);
    void addParcelle(SqlCustomModel *model, QString ilotNumber, QString file, QString type, int speed, QStringList answers);
